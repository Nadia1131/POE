...
public class POE {
    ...
    public static void main(String[] args) {
        ...
        while (!validUsername) {
            username = JOptionPane.showInputDialog(null, "Enter username (must contain '_' and be no more than 5 characters):");
            if (username != null && username.contains("_") && username.length() <= 5) {
                JOptionPane.showMessageDialog(null, "Username successfully captured.");
                validUsername = true;
            } else {
                JOptionPane.showMessageDialog(null, "Username is not correctly formatted. Ensure it contains '_' and is no more than 5 characters.");
            }
        }
        ...
        while (!validPassword) {
            password = JOptionPane.showInputDialog(null, "Enter password (min 8 chars, 1 uppercase, 1 number, 1 special character):");
            if (password != null
                    && password.length() >= 8
                ...
                JOptionPane.showMessageDialog(null, "Password is not correctly formatted. It needs 8+ chars, 1 uppercase, 1 number, and 1 special character.");
            }
        }
        ...
        while (!validCell) {
            cellNumber = JOptionPane.showInputDialog(null, "Enter South African cell number (include +27 and 9 digits):");
